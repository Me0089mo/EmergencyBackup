...
class Login : AppCompatActivity() {
    ...
    /*public fun logIn2(view: View) {
        if (!isValidEmail(login_email.text.toString())) {
            alertUtils.topToast(this, "Dirección de correo invalida")
            return
        }
        val ca = CertificateAddition(applicationContext)
        val sslSocket = ca.getSslSocketConnection()
        ...
        val postRequest: StringRequest = object : StringRequest(
            ...
            Response.ErrorListener { error ->
                val msg: String = HttpsQ.getInstance(this, sslSocket).getErrorMsg(error)
        ...
        HttpsQ.getInstance(this, sslSocket).addToRequestQueue(postRequest)
    }*/
